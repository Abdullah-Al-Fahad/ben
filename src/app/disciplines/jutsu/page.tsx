...
async function getDisciplineData() {
  const res = await fetch('http://localhost:3000/api/disciplines/jutsu', { cache: 'no-store' });
  if (!res.ok) {
      ...
      <div className="py-16 sm:py-24">
        <div className="container mx-auto max-w-4xl px-6 lg:px-8">
          <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
            ...
            <p className="pt-4">
              Our athletes embody this journey, using Jiu Jitsu to achieve goals in fitness, competition, and life. Whether your aim is to compete, improve health, or develop confidence and discipline, our Jiu Jitsu program equips you with the tools to succeed.
            </p>
          </div>
        </div>
      </div>
