...
export default function AdminDashboard() {
  ...
  return (
    // This outer div now takes up the full width, covering the parent's background.
    // We remove the container class from here.
    <div className="w-full">
      {/* This new inner div now acts as the centered container for your content. */}
