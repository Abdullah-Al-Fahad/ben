...
import { SectionModal } from './landing-page-sections/SectionModal';
...
export default function AdminDashboard() {
  ...
  const managementSections = [
    ...
    { href: 'admin/landing-page-sections', title: 'Landing Page', description: 'Edit all sections of the landing page.', icon: Component },
    { href: '/admin/settings', title: 'Landing Page Hero', description: 'Configure landing page hero section.', icon: Settings },
    
  ];

  const heroSections = [
    { id: 'disciplines-hero-section', title: 'Disciplines Hero', description: 'Edit the hero section of the disciplines page.', icon: ShieldCheck },
    { id: 'coaches-hero-section', title: 'Coaches Hero', description: 'Edit the hero section of the coaches page.', icon: Presentation },
    { id: 'pricing-hero-section', title: 'Pricing Hero', description: 'Edit the hero section of the pricing page.', icon: Ticket },
    { id: 'schedule-hero-section', title: 'Schedule Hero', description: 'Edit the hero section of the schedule page.', icon: Clapperboard },
  ];
  ...
  return (
    <div className="container mx-auto py-10">
        ...
        <Card className="bg-white/50 dark:bg-white/10 backdrop-blur-lg border border-gray-200 dark:border-white/20 rounded-xl shadow-lg text-gray-800 dark:text-white">
          ...
          <CardContent>
            <p className="text-gray-700 dark:text-gray-200">
              Select a category below or from the sidebar to get started.
            </p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Hero Section Management</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {heroSections.map((section, i) => (
            <motion.div
              ...
              initial="initial"
              animate="animate"
              transition={{ duration: 0.5, delay: (managementSections.length + i) * 0.1 }}
